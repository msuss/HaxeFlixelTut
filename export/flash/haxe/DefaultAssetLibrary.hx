...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/tiled/tiles.png", AssetType.IMAGE);
...
@:keep class __ASSET__assets_data_map_tmx extends openfl.utils.ByteArray { }
...
@:file("assets/data/map.tmx") class __ASSET__assets_data_map_tmx extends flash.utils.ByteArray {}
